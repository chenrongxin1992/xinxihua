...
router.get('/pripdf',function(req,res){
...
}).get('/pripdf_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'pdf\') and ispublic=0 and isdelete=0'
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'pdf\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
				}else{
					console.log('check docs-->',result)
...
router.get('/prippt',function(req,res){
...
}).get('/prippt_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'ppt\',\'pptx\') and ispublic=0 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'ppt\',\'pptx\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/priword',function(req,res){
...
}).get('/priword_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'doc\',\'docx\') and ispublic=0 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'doc\',\'docx\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/priexcel',function(req,res){
...
}).get('/priexcel_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'xls\',\'xlsx\') and ispublic=0 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'xls\',\'xlsx\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pritxt',function(req,res){
...
}).get('/pritxt_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'txt\') and ispublic=0 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'txt\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/priimg',function(req,res){
...
}).get('/priimg_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			//count
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'jpg\',\'png\',\'jpeg\',\'gif\',\'PNG\',\'JPG\',\'JPEG\',\'GIF\') and ispublic=0 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'jpg\',\'png\',\'jpeg\',\'gif\',\'PNG\',\'JPG\',\'JPEG\',\'GIF\') and ispublic=0 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubppt',function(req,res){
...
}).get('/pubppt_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'ppt\',\'pptx\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'ppt\',\'pptx\') and ispublic=1 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubword',function(req,res){
...
}).get('/pubword_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'doc\',\'docx\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'doc\',\'docx\') and ispublic=1 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubexcel',function(req,res){
...
}).get('/pubexcel_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'xls\',\'xlsx\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'xls\',\'xlsx\') and ispublic=1 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubtxt',function(req,res){
...
}).get('/pubtxt_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'txt\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'txt\') and ispublic=1 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubimg',function(req,res){
...
}).get('/pubimg_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'jpg\',\'png\',\'jpeg\',\'gif\',\'PNG\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			...
			limit = parseInt(limit)
			console.log('check -- >',limit,page,numSkip)
			let searchsql = 'select * from docinfo where filetype in (\'jpg\',\'png\',\'jpeg\',\'gif\',\'PNG\') and ispublic=1 and isdelete=0 limit ?,?'  
			connection.query(searchsql,[numSkip,limit],function(err,result){
				if(err){
					console.log('priword router searchsql err',err)
					cb(err)
...
router.get('/pubpdf',function(req,res){
...
}).get('/pubpdf_data_mongover',function(req,res){
	...
	async.waterfall([
		function(cb){
			let countsql = 'select count(*) as \'count\' from docinfo where filetype in (\'pdf\') and ispublic=1 and isdelete=0'
			connection.query(countsql,function(err,result,fields){
				if(err){
					console.log('mysql select err',err)
					cb(err)
		...
		function(total,cb){
			if(keyword){
				...
				let numSkip = (page-1)*limit
					limit = parseInt(limit)
					console.log('check -- >',limit,page,numSkip)
					let searchsql = 'select * from docinfo where filetype in (\'pdf\') and ispublic=1 and isdelete=0 and (filename like ?) limit ?,?'  
					connection.query(searchsql,['%'+keyword+'%',numSkip,limit],function(err,result){
						if(err){
							console.log('priword router searchsql err',err)
							cb(err)
						}else{
							console.log('check docs-->',result)
							//增加一步获取数量
							let searchsql_1 = 'select count(*) as \'count\' from docinfo where filetype in (\'pdf\') and ispublic=1 and isdelete=0 and (filename like ?) limit ?,?'  
							connection.query(searchsql_1,[keyword,numSkip,limit],function(er,re){
								if(er){
									console.log('er--->',er)
									cb(er)
								}
								cb(null,result,re[0].count)
							})
							//cb(null,result,total)
						}
					})
				...
				let numSkip = (page-1)*limit
					limit = parseInt(limit)
					console.log('check -- >',limit,page,numSkip)
					let searchsql = 'select * from docinfo where filetype in (\'pdf\') and ispublic=1 and isdelete=0 limit ?,?'  
					connection.query(searchsql,[numSkip,limit],function(err,result){
						if(err){
							console.log('priword router searchsql err',err)
							cb(err)
...
//上传
router.get('/upload_mongover',function(req,res){
	console.log('in user router upload')
	return res.render('user/upload')
}).post('/upload_mongover',function(req,res){
			    ...
			    form.parse(req, function(err, fields, files) {
			    	...
			    	newfs.copy(tmpfilename,nochinesesrc,function(newfserr){
			    		...
			    		fs.rename(tmpfilename,userDir+'\\'+newfullfilename,function(err,fsresult){
					    	...
					    	let uploadaddsql = 'INSERT INTO docinfo(srctmpname,sourcenochinese,imgsuolvepath,imgsrc,downloadLink,'+
					    						'previewlink,cn,alias,filename,finalname,filetype,filesize,filepath,created_time) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
								uploadaddsql_params = [srctmpname,nochinesesrc,userDir+'\\'+finalname2,result.user.cn + result.user.alias + '/' + newfullfilename,
														'http://qiandao.szu.edu.cn:81/csseinfo/myfile/'+result.user.cn+result.user.alias+'/'+newfullfilename,
														'http://qiandao.szu.edu.cn:81/csseinfo/publicfile/'+result.user.cn+result.user.alias+'/'+newfullfilename,
														result.user.cn,result.user.alias,newfullfilename,finalname2,filetype,filesize+' Byte',
														userDir+'\\'+newfullfilename,moment().format('YYYY-MM-DD')]


							connection.query(uploadaddsql,uploadaddsql_params,function (err, result) {
						        if(err){
						       ...
						       console.log('files---->',files)
						    	console.log('files---->',files.file[0].headers)
						    	return res.json({'code':0,'doc':result})
							});
...
router.post('/pubtopri',function(req,res){
	...
	console.log('_id--->',_id)
	let updatesql = 'update docinfo set ispublic=0 where id=?'
	connection.query(updatesql,[_id],function(err,result){
		if(err){
...
router.post('/pritopub',function(req,res){
	let _id = req.body._id
	console.log('_id--->',_id)
	let updatesql = 'update docinfo set ispublic=1 where id=?'
	connection.query(updatesql,[_id],function(err,result){
		if(err){
			console.log('pritopub err',err)
			return res.json({'code':-1,'msg':err})
		}
		console.log('pritopub success')
		return res.json({'code':0,'msg':'success'})
	})
...
router.post('/delwendang',function(req,res){
	let _id = req.body._id
	console.log('_id--->',_id)
	let updatesql = 'update docinfo set isdelete=1 where id=?'
	connection.query(updatesql,[_id],function(err,result){
		if(err){
...
router.post('/addtags',function(req,res){
	let tagstr = req.body.tags,
		_id = req.body._id
		//tagarr = tagstr.split(',')
	console.log('tagarr--->',tagstr)
	let tagsql = 'select filetag as \'filetag\' from docinfo where id=?'
	connection.query(tagsql,[_id],function(err,result){
		if(err){
		...
		let updatesql = 'update docinfo set filetag=? where id=?'
			connection.query(updatesql,[finaltag,_id],function(err,result){
				if(err){
...
router.post('/removedfile',function(req,res){
	...
	console.log('filename--->',filename)
	let updatesql = 'update docinfo set filename=?,isdelete=1 where id=?'
	connection.query(updatesql,[filename,_id],function(err,result){
		if(err){
